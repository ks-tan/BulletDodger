...
{	
	public static class Plugin
	{
		...
		public static event Action<string> OnPlatformId;
		...
		internal static void RaiseOnPlatformId(string platormId)
		{
			if (OnPlatformId != null) {
				OnPlatformId(platormId);
			}
		}
		...
		internal static void GetPlatformId()
		{
			AndroidAdapter.Call("getPlatformId", "");
		}
